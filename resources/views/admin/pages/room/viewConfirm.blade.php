...
@section('breadcrumbs_no_url')
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
            <h3 class="txt-color-blueDark"><i class="fa-fw fa fa-users"></i> Kiểm duyệt phòng</h3>
        </div>
    </div>
@endsection
...
@section('content')
    <section id="widget-grid" class="">
        {!! Form::open(array(
            ...
            'method' => 'post',
            'url'=> route('room.confirm', $data->id)
        )) !!}
                        ...
                        <div id="new" class="tab-pane fade {{$class['new']}}">
                            <div class="x_content">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Số phòng <span class="required">*</span></label>
                                    <div class="col-md-10">
                                        {!! Form::text('room_number', $dataNew['room_number'], array('class' => 'form-control', 'placeholder' => 'Số phòng')) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tên phòng <span class="required">*</span></label>
                                    <div class="col-md-10">
                                        {!! Form::text('name', $dataNew['name'], array('class' => 'form-control', 'placeholder' => 'Tên phòng')) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Số tiền <span class="required">*</span></label>
                                    <div class="col-md-10">
                                        {!! Form::number('price', $dataNew['price'], array('class' => 'form-control', 'min' => 1000)) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
