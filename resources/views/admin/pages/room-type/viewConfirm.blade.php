...
@section('breadcrumbs_no_url')
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
            <h3 class="txt-color-blueDark"><i class="fa-fw fa fa-users"></i> Kiểm duyệt loại phòng</h3>
        </div>
    </div>
@endsection
...
@section('content')
    <section id="widget-grid" class="">
        {!! Form::open(array(
            ...
            'method' => 'post',
            'url'=> route('room-type.confirm', $data->id)
        )) !!}
        ...
        <div class="row">
                        ...
                        <div id="old" class="tab-pane fade {{ $class['old'] }}">
                            <div class="x_content">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tên loại phòng<span
                                                class="required">*</span></label>
                                    <div class="col-md-10">
                                        {!! Form::text('name', $data->name, array('class' => 'form-control', 'placeholder' => 'Tên loại phòng', 'readonly'=>'readonly')) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="x_content">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Tên loại phòng<span
                                                class="required">*</span></label>
                                    <div class="col-md-10">
                                        {!! Form::text('name', $dataNew['name'], array('class' => 'form-control', 'placeholder' => 'Tên loại phòng', 'readonly'=>'readonly')) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Slug <span class="required">*</span></label>
            ...
            <div class="col-md-3">
                @php
                    ...
                    $id = $data->id;
                @endphp
                @include('admin.blocks.box.confirm',['route_cancel'=> route('room-type.confirmActionCancel', $data->id), 'route_apply'=> route('room-type.confirmActionApply', $data->id)])
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Tình trạng</h2>
                        <ul class="nav navbar-right panel_toolbox">
                ...
                @if($dataNew['image'] !== null)
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div class="form-group">
                                <img id="imagePreview"
                                     src="{{ asset('public/upload/images/room-type/' . $dataNew['image']) }}"
                                     alt="image preview"
                                     style="width: 100%"/>
                            </div>
                        </div>
